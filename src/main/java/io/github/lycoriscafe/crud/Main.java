...
public class Main {
    public static void main(String[] args) throws SQLException, ScannerException, IOException {
        Database.initializeConnection();

        var httpServerConfiguration = new HttpServerConfiguration("io.github.lycoriscafe.crud", "NexusTemp");
